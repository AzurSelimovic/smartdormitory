...
<body>
        <sesction id='dashboard'>
            ...
            <!-- Menu END-->
            <div id='main'>
            <form action='add_news_p.php' method='post' enctype='multipart/form-data'>
                    <p>Naslov:</p><br/>
                    <input type='text' name='n_title' required><br>
                    <p>Link slike:</p><br/>
                    <input type='file' name='someimage' required><br/>
                    <p>Tekst:</p><br/>
                    <textarea cols='80' rows='10' name='n_text' required></textarea><br/>
