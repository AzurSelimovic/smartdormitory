<?php
    ...
    if(empty($_SESSION['mUserId'])  && empty($_SESSION['password']))
        ...
        $uso = $row['uso'];
        $grade = $row['grade'];
        $dosijeUcenika = $row['dosijeUcenika'];
        $type = $row['type'];
        $date_b = $row['date_b'];
...
<body>
        <sesction id='dashboard'>
            ...
            <div id='main'>
                ...
                <hr />
                <p>Ime i prezime:<b> $firstName $lastName</b></p>
                <p>Datum rođenja:<b> $date_b </b></p>
                <h4>Porodični status:</h4>
                <hr />
                <p>Ime i prezime oca:<b> $fatherName</b></p>
                <p>Ime i prezime majke:<b> $motherName</b></p>
                <p>Zanimanje oca:<b> $fJob</b></p>
                <p>Zanimanje majke:<b> $mJob</b></p>
                <p>Broj članova porodice:<b> $family_members</b></p>
                <h4>Obrazovanje:</h4>
                <hr />
                <p>Naziv škole:<b> $school_name</b></p>
                <p>Izborno područje:<b> $uso</b></p>
                <p>Razred:<b> $grade</b></p>
        </sesction>
</body>
</html>
"
